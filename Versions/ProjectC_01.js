...
GouroudBox = new VBObox1();		  // "  "  for first set of custom-shaded 3D parts
...
//=============================================================================
  ...
  GouroudBox.init(gl);		//  "		"		"  for 1st kind of shading & lighting
...
var b4Wait = b4Draw - g_lastMS;
  ...
  if(g_show1 == 1) { // IF user didn't press HTML button to 'hide' VBO1:
    GouroudBox.switchToMe();  // Set WebGL to render from this VBObox.
  	GouroudBox.adjust();		  // Send new values for uniforms to the GPU, and
  	GouroudBox.draw();			  // draw our VBO's contents using our shaders.
	  }
