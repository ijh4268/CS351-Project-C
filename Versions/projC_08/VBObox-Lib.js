...
// b) Create VBO on GPU, fill it------------------------------------------------
  ...
  this.lamp1.I_pos.elements.set([0.0, 0.0, 100.0]);
  this.lamp1.I_ambi.elements.set([0.4, 0.4, 0.4]); 
  this.lamp1.I_diff.elements.set([1.0, 1.0, 1.0]); //* set diffuse light (white)
  this.lamp1.I_spec.elements.set([1.0, 1.0, 1.0]); //* set specular light (white)
}
...
function VBObox2() {
  ...
  // b) Create VBO on GPU, fill it------------------------------------------------
    ...
    this.lamp2.I_pos.elements.set([0.0, 0.0, 100.0]);
    this.lamp2.I_ambi.elements.set([0.4, 0.4, 0.4]); 
    this.lamp2.I_diff.elements.set([1.0, 1.0, 1.0]); //* set diffuse light (white)
    this.lamp2.I_spec.elements.set([1.0, 1.0, 1.0]); //* set specular light (white)
  }
