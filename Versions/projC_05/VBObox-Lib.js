...
// b) Create VBO on GPU, fill it------------------------------------------------
  ...
  if(!this.u_ModelMatrixLoc || !this.u_NormalMatrixLoc || !this.u_LightColorLoc || !this.u_LightPositionLoc || !this.u_AmbientLightLoc) {
...
gl.uniform3f(this.u_LightColorLoc, 0.8, 0.8, 0.8); // * Set the light color (white)
gl.uniform3f(this.u_LightPositionLoc, 5.0, 8.0, 7.0); // * Set the light direction (world coords)
